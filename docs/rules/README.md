...
| Rule | Identifiers | Page |
| --- | --- | --- |
| One Pod is holding up every Pod after it | `STATEFULSET_ORDERED_ROLLOUT_BLOCKED` | [STATEFULSET_ORDERED_ROLLOUT_BLOCKED.md](STATEFULSET_ORDERED_ROLLOUT_BLOCKED.md) |
| A replica's volume is not usable | `STATEFULSET_CLAIM_NOT_BOUND`, `STATEFULSET_CLAIM_NOT_FOUND` | [STATEFULSET_CLAIM_NOT_BOUND.md](STATEFULSET_CLAIM_NOT_BOUND.md) |
| The governing Service does not give the Pods an identity | `STATEFULSET_SERVICE_NOT_FOUND`, `STATEFULSET_SERVICE_NOT_HEADLESS` | [STATEFULSET_SERVICE_NOT_FOUND.md](STATEFULSET_SERVICE_NOT_FOUND.md) |
| The rollout is waiting by design | `STATEFULSET_UPDATE_ON_DELETE`, `STATEFULSET_UPDATE_PARTITIONED`, `STATEFULSET_SCALED_TO_ZERO` | [STATEFULSET_UPDATE_ON_DELETE.md](STATEFULSET_UPDATE_ON_DELETE.md) |
| The StatefulSet has fewer ready replicas than it asks for | `STATEFULSET_UNAVAILABLE_REPLICAS` | [STATEFULSET_ORDERED_ROLLOUT_BLOCKED.md](STATEFULSET_ORDERED_ROLLOUT_BLOCKED.md) |
